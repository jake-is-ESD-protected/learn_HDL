...
add wave -noupdate -divider Error_injection
add wave -noupdate /tb_uart_rx/do_error
add wave -noupdate /tb_uart_rx/noise
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {456004367 ps} 0}
...
update
WaveRestoreZoom {0 ps} {494035500 ps}
